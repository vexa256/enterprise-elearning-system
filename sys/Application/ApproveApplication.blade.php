            ...
            @isset($Apps)
                @foreach ($Apps as $data)
                    <tr>
                        ...
                        <td>
                            <a data-doc="Course Application"
                                data-source="{{ asset('assets/data/' . $data->CV) }}"
                        ...
                        <td>
                            <a data-doc="Course Application"
                                data-source="{{ asset('assets/data/' . $data->StudentID) }}"
                                data-bs-toggle="modal" href="#PdfJS"
                                class="btn btn-sm  PdfViewer btn-info"> <i
                                    class="fas fa-file-pdf" aria-hidden="true"></i>
                            </a>
                        ...
                        <td>
                            <a data-bs-toggle="modal"
                                href="#ViewMore{{ $data->Uid }}"
                                class="btn btn-sm  btn-warning"> <i
                                    class="fas fa-binoculars me-1"
                                    aria-hidden="true"></i>
                            </a>
                        </td>
                    </tr>
...
@include(
    'Application.ViewMoreStudentDetails'
)
