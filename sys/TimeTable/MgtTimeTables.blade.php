...
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    {!! Alert($icon = 'fa-info', $class = 'alert-primary', $Title = 'Lets create a timetable for the selected course', $Msg = null) !!}


</div>
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    {{ HeaderBtn($Toggle = 'New', $Class = 'btn-danger', $Label = 'New Course Timetable ', $Icon = 'fa-plus') }}
    ...
    $data = [
        ...
        'route' => route('DeleteDoc', ['id' => $data->id, 'TableName' => 'course_time_tables']),
...
@include('TimeTable.NewTimeTable')
