...
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    {!! Alert($icon = 'fa-info', $class = 'alert-primary', $Title = ' Attempt the Practical  Assessment', $Msg = null) !!}

    <input type="text" class="d-none ExamTimerValue" value="{{ $Timer }}">

    <div class="bg-dark fs-5 shadow-lg alert text-light fw-bolder">
        <span class="fs-5">
            Please Attempt The Given Assessment Within The Assigned Time
        </span>
...
@include('Students.PostTests.RecordAnswer')
