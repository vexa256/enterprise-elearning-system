<div class="modal fade" id="PracticalExams">
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header bg-gray">
                <h5 class="modal-title"> Practical Tests Attached to the
                    course
                    your enrolled in. |
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a target="_blank"
                                            ...
                                            href="{{ route('AttemptPracticalTest', ['id' => $data->uuid]) }}">
