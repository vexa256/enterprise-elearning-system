...
/***/ "./assets/js/PretestSec.js":
/*!*********************************!*\
  !*** ./assets/js/PretestSec.js ***!
  \*********************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {

__webpack_require__.g.PretestSec = function () {
  var FORM_DATA = {
    "CID": $('#CID').val(),
  ...
  axios.post(API_PATH + 'PretestSecurity', FORM_DATA).then(function (response) {
...
__webpack_require__(/*! ./js/PretestSec */ "./assets/js/PretestSec.js");

__webpack_require__(/*! ./js/PretestLogic */ "./assets/js/PretestLogic.js");
})();
