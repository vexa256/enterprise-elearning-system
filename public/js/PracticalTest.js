...
/***/ "./assets/js/CatchAllAxiosErrors.js":
/*!******************************************!*\
  !*** ./assets/js/CatchAllAxiosErrors.js ***!
  \******************************************/
...
__webpack_require__.g.API_PATH = location.protocol + "//" + location.host + "/api/"; // alert(API_PATH);

__webpack_require__.g.axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");

/***/ }),

/***/ "./assets/practical/PracTestLogic.js":
/*!*******************************************!*\
  !*** ./assets/practical/PracTestLogic.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
...
document.addEventListener('DOMContentLoaded', function () {
  __webpack_require__.g.ExamTimeOutAction = function () {
    var timerInterval;
    Swal.fire({
  ...
  __webpack_require__.g.RecordExamModal = new bootstrap.Modal(document.getElementById('AnswerQtn'), {
    keyboard: false
  });
  __webpack_require__.g.ExamTimerValue = $('.ExamTimerValue').val();
  $('.spanTimer').html('Assessment Duration: ' + ExamTimerValue / 60000 + ' Minutes');

  __webpack_require__.g.StartTimer = function () {
    $('.spanTimer').html(' ');
    var ExamTime = new Date().getTime() + parseInt(ExamTimerValue);

    if ($('.spanTimer').length > 0) {
      $('.spanTimer').countdown(ExamTime) // removed the elapsed: true
      .on('update.countdown', function (event) {
        ...
        if (event.elapsed) {
          ...
          $this.html(event.strftime('Time left to the end of exam  : <span>%H:%M:%S</span>'));
        }
...
/***/ "./assets/practical/PracTestSec.js":
/*!*****************************************!*\
  !*** ./assets/practical/PracTestSec.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {

__webpack_require__.g.PracTestSec = function () {
  var FORM_DATA = {
    "CID": $('#CID').val(),
  ...
  axios.post(API_PATH + 'PracticalTestSecurity', FORM_DATA).then(function (response) {
...
(() => {
/*!*********************************!*\
  !*** ./assets/PracticalTest.js ***!
  \*********************************/
__webpack_require__(/*! ./js/globals */ "./assets/js/globals.js");

__webpack_require__(/*! ./js/CatchAllAxiosErrors.js */ "./assets/js/CatchAllAxiosErrors.js");

__webpack_require__(/*! ./practical/PracTestSec.js */ "./assets/practical/PracTestSec.js");

__webpack_require__(/*! ./practical/PracTestLogic */ "./assets/practical/PracTestLogic.js");
})();
